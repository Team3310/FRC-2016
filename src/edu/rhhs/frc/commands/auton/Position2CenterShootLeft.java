...
public class Position2CenterShootLeft extends CommandGroup {
    ...
    public Position2CenterShootLeft() {
        ...
        addSequential(new DriveTrainStraightMP(109, DriveTrain.MP_AUTON_MAX_STRAIGHT_VELOCITY_INCHES_PER_SEC, true, 0));
        ...
        addSequential(new WaitCommand(0.3));
        addSequential(new DriveTrainStraightMP(22, DriveTrain.MP_AUTON_MAX_STRAIGHT_VELOCITY_INCHES_PER_SEC, true, 60));
        addSequential(new WaitCommand(0.3));
        addSequential(new CameraTurnToBestTarget());
        addSequential(new WaitCommand(0.3));
        ...
        addSequential(new DriveTrainStraightMP(109, DriveTrain.MP_AUTON_MAX_STRAIGHT_VELOCITY_INCHES_PER_SEC, true, 175));
    }
}
