...
import edu.rhhs.frc.commands.ShooterAlignmentShootAndRetract;
...
public class Position5CenterShootRight extends CommandGroup {
    ...
    public Position5CenterShootRight() {
        ...
        addSequential(new DriveTrainStraightMP(120, DriveTrain.MP_AUTON_MAX_STRAIGHT_VELOCITY_INCHES_PER_SEC, true, true, 0));
        ...
        addSequential(new ShooterAlignmentShootAndRetract());
