...
public class DriveTrainStraightMPLaser extends Command
{
	...
	public DriveTrainStraightMPLaser(double distanceInches, double maxVelocityInchesPerSec, boolean useGyroLock, boolean useAbsolute, double desiredAbsoluteAngle) {
	...
	protected boolean isFinished() {
		return RobotMain.driveTrain.getLaserSensorStatus() || RobotMain.driveTrain.isFinished(); 
	}
