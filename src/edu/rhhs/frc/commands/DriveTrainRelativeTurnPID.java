...
public class DriveTrainRelativeTurnPID extends Command
{
	...
	public DriveTrainRelativeTurnPID(double relativeTurnAngleDeg, MPSoftwareTurnType turnType) {
	...
	protected void initialize() {
		RobotMain.driveTrain.setRelativeTurnPID(relativeTurnAngleDeg, 0.3, 0.1, turnType);
	}
